...
@section('content')
    <div class="container container-tight py-4">
        ...
        <div class="card card-md">
            <div class="card-body">
                <h2 class="h2 text-center mb-4">{{ __('Đăng Nhập vào Tài Khoản')}}</h2>
                <form action="{{route('login')}}" method="POST" autocomplete="off" novalidate>
                    ...
                    <div class="mb-2">
                        <label class="form-check">
                            ...
                            <span class="form-check-label">{{ __('Nhớ mật khẩu?')}}</span>
                        </label>
                    </div>
